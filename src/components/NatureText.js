    ...
    return(
        ...
        <div className = "row">
            <div className="col-lg-4">
                <TextCard title = 'Forest' quote = {quoteNature1} author = 'Peter Wohlleben (The Hidden Life of Trees:)' book = {bookNature1} link = 'https://www.amazon.com/Hidden-Life-Trees-Communicate_Discoveries-Secret/dp/1771642483/ref=sr_1_1?dchild=1&keywords=The+Hidden+Life+of+Trees&qid=1593654172&sr=8-1' clickTitle = {props.searchTerm} videoSearch = 'Forest' weatherSearch = '' />
            </div>
            <div className="col-lg-4">
                <TextCard title = 'Sea' quote = {quoteNature2} author = 'Jules Verne (20,000 Leagues Under the Sea)' book = {bookNature2} link = 'https://www.amazon.com/Twenty-Thousand-Leagues-Under-Illustrated/dp/1950435067/ref=sr_1_2?dchild=1&keywords=20%2C000+Leagues+Under+the+Sea+book&qid=1593654487&sr=8-2' clickTitle = {props.searchTerm} videoSearch = 'Sea' weatherSearch = '' />
            </div>
            <div className="col-lg-4">
                <TextCard title = 'Walden Pond' quote = {quoteNature3} author = 'Henry David Thoreau (Walden)' book = {bookNature3} link = 'https://www.amazon.com/Walden-Henry-David-Thoreau/dp/1949982475/ref=sr_1_1_sspa?dchild=1&keywords=walden+book&qid=1593654608&sr=8-1-spons&psc=1&spLa=ZW5jcnlwdGVkUXVhbGlmaWVyPUEyUEtLUlFBSkRDMVBSJmVuY3J5cHRlZElkPUEwNjA2MDA1MlZST0U5WEdSRzZXTSZlbmNyeXB0ZWRBZElkPUEwNjE0NjU3TU9ZUEs3WkRaVUpCJndpZGdldE5hbWU9c3BfYXRmJmFjdGlvbj1jbGlja1JlZGlyZWN0JmRvTm90TG9nQ2xpY2s9dHJ1ZQ==' clickTitle = {props.searchTerm} videoSearch = 'Walden Pond' weatherSearch = 'Concord, Massachusetts' />
            </div>
        </div>
        </div>
    )
