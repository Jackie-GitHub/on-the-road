    ...
    return (
        ...
        <div className = "row">
            <div className="col-lg-6">
                <TextCard title = 'Bali' quote = {quoteSmalltown1} author = 'Elizabeth Gilbert (Eat, Pray, Love)' book = {bookSmalltown1} link = 'https://en.wikipedia.org/wiki/Eat,_Pray,_Love' clickTitle = {props.searchTerm} videoSearch = 'Bali' weatherSearch = 'Denpasar' />
            </div>
            <div className="col-lg-6">
                <TextCard title = 'Provence' quote = {quoteSmalltown2} author = 'Peter Mayle (A Year in Provence)' book = {bookSmalltown2} link = 'https://en.wikipedia.org/wiki/A_Year_in_Provence' clickTitle = {props.searchTerm} videoSearch = 'Provence' weatherSearch = 'Aix-en-Provence' />
            </div>
        </div>
        </div>
    )
